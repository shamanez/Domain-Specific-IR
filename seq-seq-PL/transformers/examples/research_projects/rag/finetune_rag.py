...
from lightning_base import BaseTransformer,Seq2SeqDataModule,  generic_train  # noqa
from args import GenericArgs
...
class GenerativeQAModule(BaseTransformer):
    ...
    def _step(self, batch: dict) -> Tuple:
        ...
        #self.ids_to_clean_text(target_ids)
        rag_kwargs = {}
        ...
        #     lm_labels.masked_fill_(lm_labels == -100, self.tokenizer.pad_token_id)
           

        # assert decoder_input_ids is not None
    
        # outputs = self( #huggiface class outputs the seq-seq loss
        #     source_ids,
    ...
    def get_dataset(self, type_path): #-> Seq2SeqDataset:
        ...
        #tokenizer =self.tokenizer# AutoTokenizer.from_pretrained('facebook/bart-base')
        split_name='test'
        test_file='/home/gsir059/Videos/Custom-Hug-New/transformers/examples/research_projects/rag/data/test.csv'
        data_files = {}
        ...
        column_names = datasets[split_name].column_names
    ...
    def preprocess_function(self,examples):
        ...
        model_inputs = self.tokenizer(inputs, max_length=self.hparams.max_source_length, padding=padding, truncation=True)
...
if __name__ == "__main__":
    ...
    parser = GenericArgs.add_data_specific_args(parser) #general seq-data pipeline
    parser = GenericArgs.add_generic_model_args(parser) #general hugginface model args
    parser = GenericArgs.add_training_args(parser)#training argumenets for both hug and pl
